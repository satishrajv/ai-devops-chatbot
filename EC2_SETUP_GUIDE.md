...
Your current setup: EC2 instance `35.174.138.165` with Jenkins running
...
docker run -d \
    ...
    -p 5000:5000 \
    -p 8501:8501 \
    -e JENKINS_URL=http://35.174.138.165:8080 \
...
|----------|---------|---------|
| `JENKINS_URL` | `http://35.174.138.165:8080` | Jenkins server URL |
...
1. **Test RAG Chatbot**
   - Go to http://35.174.138.165:8501
...
- [ ] Flask API responding: http://35.174.138.165:5000/health
- [ ] Streamlit UI loaded: http://35.174.138.165:8501
