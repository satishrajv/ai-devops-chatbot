...
- ❌ Health checks **fail** at `http://35.174.138.165:5000/health`
- ❌ Streamlit UI unreachable at `http://35.174.138.165:8501`
...
Go to http://35.174.138.165:8080 and click "Build Now"
...
- Jenkins Dashboard: http://35.174.138.165:8080
