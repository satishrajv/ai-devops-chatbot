...
**Via Web UI:**
```
http://35.174.138.165:8080/job/ai-devops-pipeline/4/console
```
...
**Via Web UI:**
```
http://35.174.138.165:8080/log/all
```
...
**From browser:**
```
http://35.174.138.165:5000/health
http://35.174.138.165:5000/api/info
