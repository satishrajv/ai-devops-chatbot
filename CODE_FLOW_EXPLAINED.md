...
### **When User Accesses Flask (http://35.174.138.165:5000/health):**
...
### **When User Accesses Streamlit (http://35.174.138.165:8501):**
...
### **User Interaction:**
- User visits Flask: http://35.174.138.165:5000 → Flask handles request
- User visits Streamlit: http://35.174.138.165:8501 → Streamlit handles request
